...
Chỉ mục tài liệu liên miền: ADR, CI/CD, threat model, monitoring, release,
environment và runbook vận hành.

Mỗi quyết định kiến trúc quan trọng nên có ADR riêng gồm bối cảnh, lựa chọn,
quyết định, hệ quả và trạng thái.
...
- [Android Internal Testing](./android-internal-testing.md): ký AAB, Play Console và phân phối QA.
